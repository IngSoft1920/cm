        ...
        <header>
            ...
            <div class="navbar navbar-light bg-light shadow-sm">
                <div class="container d-flex align-content-start">
                    ...
                    <a class="navbar-nav" href="anadir-proveedor.html">Añadir Proveedor</a>
                </div>
            </div>
        </header>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-sm btn-outline-secondary" href="ver-proveedor.html" role="button">Ver</a>
                                            <a class="btn btn-sm btn-outline-secondary" href="editar-proveedor.html" role="button">Editar</a>
